...
const initGame = () => {
  ...
  displayGameInfo('Please place your bets');
  ...
  exchangeOrHoldCardsButton.addEventListener('click', () => {
    if (canExchangeOrHoldCards === true) {
      ...
      displayGameInfo(`you get ${pointsWonThisRound} points. want to play again?`);
    }
  });
